...
from kitsune.llm.questions.classifiers import analyze_question
...
class ClassifyQuestionsTests(TestCase):
    ...
    def test_topic_1(self):
        ...
        #     FlaggedObject.objects.filter(object_id=question.id, content_type=content_type).exists()
        # )
        # self.assertIn(question.topic, [self.tabs, self.browser_appearance])
    ...
    def test_topic_3(self):
        question = QuestionFactory(
            product=self.firefox,
            content="How do I clear my browser history?",
        )
        ...
        # self.assertFalse(question.is_spam)
        # self.assertEqual(question.topic, self.browse_history)

    def test_topic_4(self):
        question = QuestionFactory(
            product=self.firefox,
            content="How do I use picture-in-picture?",
        )
        ...
        # self.assertFalse(question.is_spam)
        # self.assertEqual(question.topic, self.pip)
