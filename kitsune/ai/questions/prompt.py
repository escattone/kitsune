...
- Your goal is to select the best topic for classifying a question related to Mozilla's
  "{product}" product.
...
def get_system_instructions(target: Literal["spam", "topic"], product: Product) -> str:
    """
