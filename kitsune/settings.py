...
#
# Connection information for Elasticsearch 9
...
ZENDESK_UPDATE_CHANNEL_FIELD_ID = config(
    "ZENDESK_UPDATE_CHANNEL_FIELD_ID", default="45938835035156", cast=int
)
...
STALE_TRANSLATION_THRESHOLD_DAYS = config(
...
WATCHDOG_GRACE_MULTIPLIER = config("WATCHDOG_GRACE_MULTIPLIER", default=2.0, cast=float)
