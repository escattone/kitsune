TOPICS_BY_PRODUCT = {
    "Firefox": [
        ...
        },
        {
            "title": "Accounts",
            "description": (
                "Manage your accounts and profiles for Mozilla's products and services."
            ),
            "subtopics": [
                {
                    ...
                    "subtopics": [
                        ...
                        {"title": "Location", "description": "Change your location."},
                    ],
                },
                {
                    "title": "Profiles",
            ...
            "subtopics": [
                {
                    "title": "Backup data",
                    "description": (
                        "From passwords to bookmarks, discover ways to back up your important"
                        " data."
                    ),
                    "subtopics": [],
                },
                ...
                },
                {
                    ...
                    "subtopics": [
                        ...
                        {"title": "Sync failure", "description": "Troubleshoot sync issues."},
                    ],
                },
            ],
        },
            ...
            "subtopics": [
                {
                    ...
                    "subtopics": [
                        {"title": "PiP", "description": "Troubleshoot picture in picture issues."}
                    ],
                },
                {
                    "title": "Bookmarks",
                ...
                },
                {
                    "title": "Home screen",
                    "description": (
                        '"Add Mozilla\'s products to your home screen for easy access."'
                    ),
                    "subtopics": [
                        {"title": "Dashboard", "description": "Troubleshoot dashboard issues."},
                        {"title": "New tab", "description": "Troubleshoot new tab issues."},
                    ],
                },
                {
                    ...
                    "subtopics": [
                        {"title": "Images", "description": "Troubleshoot images issues."},
                        {"title": "PDFs", "description": "Troubleshoot PDFs issues."},
                    ],
                },
                {
                    "title": "Links",
            ...
            "subtopics": [
                {
                    ...
                    "subtopics": [
                        ...
                        {"title": "Print", "description": "Troubleshoot print issues."},
                    ],
                },
                {
                    "title": "Save content",
            ...
            "subtopics": [
                {
                    "title": "Install",
                    "description": (
                        "Learn about how to install Mozilla's products on your devices."
                    ),
                    "subtopics": [
                        {"title": "ESR", "description": "Troubleshoot ESR issues."},
                        {
        ...
        },
        {
            ...
            "subtopics": [
                ...
                },
                {
                    ...
                    "description": (
                        "Use two-factor authentication to add an extra layer of security when"
                        " signing in."
                    ),
                    "subtopics": [
                        {
        ...
        },
        {
            ...
            "subtopics": [
                ...
                },
                {
                    ...
                    "subtopics": [
                        {"title": "App crash", "description": "Troubleshoot app crash issues."},
                        {
                    ...
                    "subtopics": [
                        {
                            ...
                            "description": (
                                "Troubleshoot blocked application/service/website issues."
                            ),
                        },
                        {
            ...
            "subtopics": [
                {
                    "title": "Encryption",
                    "description": (
                        "Use encryption features to keep yourself and your data secure."
                    ),
                    "subtopics": [],
                },
                {
                ...
                },
                {
                    ...
                    "subtopics": [
                        {"title": "Cookies", "description": "Troubleshoot cookies issues."}
                    ],
                },
            ],
        },
            ...
            "subtopics": [
                {
                    ...
                    "subtopics": [
                        {"title": "Extensions", "description": "Troubleshoot extensions issues."},
                        {"title": "Themes", "description": "Troubleshoot themes issues."},
                    ],
                },
                {
                    "title": "Autofill",
                    "description": (
                        "Automatically fill your personal information into form fields and more."
                    ),
                    "subtopics": [],
                },
                {
                    "title": "Customization",
                    "description": (
                        "Customize product appearance and functionality to suit your preferences."
                    ),
                    "subtopics": [
                        {
                ...
                },
                {
                    ...
                    "description": (
                        "Learn how to import and export product settings for easy setup and"
                        " migration."
                    ),
                    "subtopics": [
                        {"title": "Add device", "description": "Troubleshoot add device issues."}
                    ],
                },
                {
                    "title": "Languages",
    ...
    "Mozilla VPN": [
        {
            ...
            "subtopics": [
                ...
                },
                {
                    ...
                    "description": (
                        "Recover your account if you lose access to it or encounter issues."
                    ),
                    "subtopics": [],
                },
            ],
            ...
            "subtopics": [
                {
                    ...
                    "subtopics": [
                        {"title": "Billing inquiry", "description": "Inquire about your billing."},
                        {
                            "title": "Declined payment",
                            "description": "Troubleshoot declined payment issues.",
                        },
                        {"title": "Sales tax", "description": "Troubleshoot sales tax issues."},
                    ],
                },
                {
                    "title": "Manage subscriptions",
                    "description": (
                        "Manage your subscriptions to Mozilla's premium products and services."
                    ),
                    "subtopics": [
                        {
                            "title": "Cancellation",
            ...
            "subtopics": [
                {
                    "title": "Masking",
                    "description": (
                        "Mask your email and phone number to better protect your privacy."
                    ),
                    "subtopics": [
                        {
                            "title": "Email masking",
            ...
            "subtopics": [
                {
                    ...
                    "subtopics": [
                        {"title": "Mask labels", "description": "Troubleshoot mask labels issues."}
                    ],
                }
            ],
        },
            ...
            "subtopics": [
                {
                    ...
                    "description": "Manage notifications in Mozilla's products.",
                    "subtopics": [
                        {"title": "Alerts", "description": "Troubleshoot alerts issues."}
                    ],
                }
            ],
        },
        ...
        },
        {
            ...
            "subtopics": [
                ...
                },
                {
                    ...
                    "subtopics": [
                        {"title": "Events", "description": "Troubleshoot events issues."}
                    ],
                },
                {
                    "title": "Contacts",
                    ...
                    "subtopics": [
                        {
                            "title": "SMS Recovery",
                            "description": (
                                "Use SMS messages as a method for account recovery and two-factor"
                                " authentication."
                            ),
                        }
                    ],
